...
const double TICKS_PER_REVOLUTION = 1996; // For reference purposes.
//const double WHEEL_RADIUS = 0.033; // Wheel radius in meters
const double circum = 0.637743;
const double WHEEL_BASE = 0.457; // Center of left tire to center of right tire
...
void Calc_Left(const std_msgs::Int32 &leftCount) {
  ...
  {         
    ...
    distanceLeft = leftTicks*circum/TICKS_PER_REVOLUTION;
  }
...
void Calc_Right(const std_msgs::Int32 &rightCount) {
  ...
  { 
    ...
    distanceRight = rightTicks*circum/TICKS_PER_REVOLUTION;
  }
